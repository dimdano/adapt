...
class _DenseLayer(nn.Sequential):
    def __init__(self, num_input_features, growth_rate, bn_size, drop_rate):
        ...
        self.add_module(
            "conv1",
            approxNN.AdaPT_Conv2d(num_input_features,
                bn_size * growth_rate,
                kernel_size=1,
                stride=1,
        ...
        self.add_module(
            "conv2",
            approxNN.AdaPT_Conv2d(bn_size * growth_rate,
                growth_rate,
                kernel_size=3,
                stride=1,
                padding=1,
...
def densenet121(pretrained=False, progress=True, device="cpu", axx_mult = 'mul8s_acc', **kwargs):
...
def densenet161(pretrained=False, progress=True, device="cpu", axx_mult = 'mul8s_acc', **kwargs):
...
def densenet169(pretrained=False, progress=True, device="cpu", axx_mult = 'mul8s_acc',  **kwargs):
    ...
    return _densenet(
        "densenet169", 32, (6, 12, 32, 32), 64, pretrained, progress, device, axx_mult = 'mul8s_acc', **kwargs
    )
